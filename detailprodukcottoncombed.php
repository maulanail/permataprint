...
<body>
    ...
    <div class="container text-center">
        <img src="gambar/521838150_hita_prev_ui.png" class="card-img-top" alt="..." width="80" height="890">
        <h2 style="padding-bottom: 10px; font-weight: bold;">KAOS COTTON COMBED</h2>
        <p>Cotton Combed merupakan kain yang terbuat dari serat kapas yang halus.</p>
        <h4 style="padding-bottom: 10px; font-weight: bold;">Karakteristik Kaos Cotton Combed</h4>
        <P>-> 100% bahan cotton combed (katun) yang halus dan nyaman dipakai.</P>
        <p>-> Adem digunakan</p>
        <p>-> Tidak mudah robek</p>
    </div>
