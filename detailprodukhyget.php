...
<body>
    ...
    <div class="container text-center">
        <img src="pic/Hyget/hyget2.png" class="card-img-top" alt="..." width="80" height="890">
        <h2 style="padding-bottom: 10px; font-weight: bold;">KAOS HYGET</h2>
        <p>Hyget merupakan kain yang terbuat dari kombinasi polyster dan cotton. jenis bahan ini terbilang tipis dibandingkan
            dengan bahan kaos lainnya.
        </p>
        <h4 style="padding-bottom: 10px; font-weight: bold;">Karakteristik Kaos Polyster</h4>
        <p>-> Tidak mudah kusut</p>
        <p>-> Permukaan kaos mengkilap</p>
    </div>
