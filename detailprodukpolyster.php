...
<body>
    ...
    <div class="container text-center">
        <img src="pic/poly/polyhijau.png" class="card-img-top" alt="..." width="80" height="890">
        <h2 style="padding-bottom: 10px; font-weight: bold;">KAOS POLYSTER</h2>
        <p>Polyster merupakan kain yang dibuat dengan menggunakan benang atau serat polyster. Serat atau kain polyster dibuat dari senyawa kimia, ethylene glycol,
            dan asam tereftalat, yang dikombinasikan dengan polyethylene terephathalate (PET) yang berasal dari minyak bumi (petroleum).
        </p>
        <h4 style="padding-bottom: 10px; font-weight: bold;">Karakteristik Kaos Polyster</h4>
        <p>-> Tidak mudah kusut</p>
        <p>-> Mudah kering</p>
        <p>-> Serat yang lentur</p>
    </div>
