  ...
  <div class="row row-cols-2 row-cols-md-4 g-2">
    <?php foreach ($produk as $row) { ?>
      <div class="col">
        ...
        <div class="card">
          <img src="gambar/<?php echo $row['upload_gambar'] ?>" width="180" height="160">
          <div class="card-body">
            <h5 class="card-title"><a href="pemesanan.php?id_produk=<?php echo $row['id_produk'] ?>"><?php echo $row["nama_produk"] ?></a></h5>
